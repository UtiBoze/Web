...
<nav class="navbar navbar-expand-sm alert-info navbar-dark justify-content-between">
	<ul class="navbar-nav">
		<li class="nav-item active">
			<h5><a class="nav-link text-dark" href="#">Пользователь</a></h5>
		</li>
		<li class="nav-item">
		...
		<li class="nav-item">
			<h5><a class="nav-link text-dark" href="logbook.php">Журнал заказов</a></h5>
		</li>
	</ul>
	<ul class="navbar-nav">
		<a class="nav-link" href="#">
	        <div class="d-inline-flex align-middle"><img src="../images/reg-img.png" width="17" height="20" class="d-inline-flex" alt=""></div>
	        <div class="d-inline-flex align-middle text-dark">Регистрация</div>
		 </a>
	</ul>
</nav>
